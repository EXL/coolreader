...
cd ../install_cr3/
strip -s cr3.exe
mv cr3.exe cr3-qt5.exe
curl -sS --upload-file cr3-qt5.exe https://transfer.sh/cr3-qt5.exe && echo -e '\n'
curl -sS --upload-file i18n/qtbase_ru.qm https://transfer.sh/qtbase_ru.qm && echo -e '\n'
